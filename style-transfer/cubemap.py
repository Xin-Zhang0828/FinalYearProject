...
parser.add_argument("--dir", default="./test/cuberesult", help="Directory in which to put the output files")
...
parser.add_argument("--input", default='./test/imgs/1.jpg',help="Input panorama file")
