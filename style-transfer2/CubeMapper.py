...
directoryName ='D:\\Code\\python\\style-transfer\\test\\imgs'
...
def equiToCube(f):
    ...
    if fileExt == "jpg" or fileExt == "jpeg" or fileExt == "png":
        #print(os.path.join(directoryName,f))
        ...
        if isEquirect(imgIn):
            ...
            if not os.path.exists(os.path.join(directoryName,components[0])):
            ...
            for face in range(6):
                ...
                savePath = os.path.join(imgDirPath,  FACE_NAMES[face])
                imgOut.save(savePath+"." + fileExt)
        imgIn.close()

if __name__ == '__main__':
    #directoryName = sys.argv[1]
    #directoryName ='D:\\Code\\python\\style-transfer\\test\\cube'
    #print(listdir(directoryName))
